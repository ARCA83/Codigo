function validarComoIrAEstudiar(hora, dinero) {
  ...
  validarUsandoOperadores("linder34" , "123456"); // datos invalidos ==> or // ingreso 2
  validarUsandoOperadores("linder3hs" , "123456"); // datos ingreso ingreso 2
  validarUsandoOperadores("linder34", "12456"); // datos invalidos // datos invalidos 2